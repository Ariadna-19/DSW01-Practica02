...
public class EmpleadoController {
    ...
    @GetMapping("/{clave}")
    public EmpleadoResponse obtenerPorClave(
        @PathVariable
        @Pattern(regexp = "^E-[0-9]{4,}$", message = "clave debe tener formato E-0001")
        String clave
    ) {
    ...
    @GetMapping
    public EmpleadoPageResponse listar(@RequestParam(defaultValue = "0") @Min(0) int page) {
