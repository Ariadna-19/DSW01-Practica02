...
- **CA-005**: Feature MUST define OpenAPI updates for any endpoint changes.
- **CA-006**: Frontend changes MUST target Angular 19 and specify impacted app/module paths.
- **CA-007**: Feature MUST document monorepo impact (workspace structure, scripts, and CI tasks).
